...
export const HIERARCHY_COLUMNS = [
  ...
  { id: 'last_station_name', label: 'Станция', accessorKey: 'last_station_name', filterable: true, isRequired: false, isDefaultVisible: true, width: '250px' },
  { id: 'last_operation_name', label: 'Операция', accessorKey: 'last_operation_name', filterable: true, isRequired: false, isDefaultVisible: true, width: '250px' },
