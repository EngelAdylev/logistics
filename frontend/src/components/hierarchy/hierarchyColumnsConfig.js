...
export const HIERARCHY_COLUMNS = [
  ...
  { id: 'last_station_name', label: 'Станция', accessorKey: 'last_station_name', filterable: true, isRequired: false, isDefaultVisible: true },
  ...
  { id: 'departure_station_name', label: 'Отправл.', accessorKey: 'departure_station_name', filterable: true, isRequired: false, isDefaultVisible: false },
  { id: 'destination_station_name', label: 'Назнач.', accessorKey: 'destination_station_name', filterable: true, isRequired: false, isDefaultVisible: false },
