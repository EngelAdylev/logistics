...
export const HIERARCHY_COLUMNS = [
  ...
  { id: 'number_railway_carriage_on_train', label: '№ ваг. на поезде', accessorKey: 'number_railway_carriage_on_train', filterable: true, isRequired: false, isDefaultVisible: false },
