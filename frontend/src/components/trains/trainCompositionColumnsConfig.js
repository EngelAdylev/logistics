...
export const TRAIN_COMPOSITION_COLUMNS = [
  ...
  { id: 'shipper_name', label: 'Отправитель', accessorKey: 'shipper_name', filterable: false, isRequired: false, isDefaultVisible: true, width: '170px' },
  { id: 'consignee_name', label: 'Получатель', accessorKey: 'consignee_name', filterable: false, isRequired: false, isDefaultVisible: true, width: '170px' },
  { id: 'cargo_name', label: 'Груз', accessorKey: 'cargo_name', filterable: false, isRequired: false, isDefaultVisible: true, width: '200px' },
  { id: 'remaining_distance', label: 'Остаток, км', accessorKey: 'remaining_distance', filterable: false, isRequired: false, isDefaultVisible: true, width: '80px' },
  ...
  { id: 'last_operation_name', label: 'Последняя операция', accessorKey: 'last_operation_name', filterable: false, isRequired: false, isDefaultVisible: false, width: '150px' },
  { id: 'last_station_name', label: 'Текущая станция', accessorKey: 'last_station_name', filterable: false, isRequired: false, isDefaultVisible: false, width: '150px' },
  ...
  { id: 'ownership', label: 'Собственность', accessorKey: 'ownership', filterable: false, isRequired: false, isDefaultVisible: false, width: '130px' },
  { id: 'weight_net', label: 'Вес нетто', accessorKey: 'weight_net', filterable: false, isRequired: false, isDefaultVisible: false, width: '90px' },
  { id: 'wagon_model', label: 'Модель вагона', accessorKey: 'wagon_model', filterable: false, isRequired: false, isDefaultVisible: false, width: '130px' },
  { id: 'renter', label: 'Арендатор', accessorKey: 'renter', filterable: false, isRequired: false, isDefaultVisible: false, width: '120px' },
